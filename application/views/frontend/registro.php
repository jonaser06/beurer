                            ...
                            <div class="divTable" style=" width:100%;display:inline-block;">
                                <div class="divTableBody" style="display:block;">
                                    <div class="divTableRow">
                                        ...
                                        <div class="divTableCell">
                                            <div class="etiquetaFormulario">Número Documento Identidad<div class="d_ob">
                                                    (*)</div>
                                            </div>
                                    ...
                                    <div class="divTableRow" id="pn_datos2">
                                        ...
                                        <div class="divTableCell">
                                            <div class="tituloTabla1">Apellido Materno<div class="d_ob">(*)</div>
                                            </div>
                                            <input type="text" size="20" maxlength="20" name="campo1" id="c_apem1"
                                                onkeypress="return soloLetras(event)" value="">
                                        </div>
                                        <div class="divTableCell">
                                    ...
                                    <div class="divTableRow">
                                        <div class="divTableCell">
                                            <div class="tituloTabla1">Contraseña<div class="d_ob">(*)</div>
                                            </div>
                                            <input type="password" size="20" maxlength="45" name="campo1" id="campo1"
                                                value="">
                                        </div>

                                        <div class="divTableCell">
                                            <div class="tituloTabla1">Repita la contraseña<div class="d_ob">(*)</div>
                                            </div>
                                            <input type="password" size="20" maxlength="45" name="campo1" id="campo1"
                                                value="">
                                        </div>
                                    ...
                                    <div class="divTableRow">
                                        ...
                                        <div class="divTableCell">
                                            <div class="tituloTabla1">Departamento<div class="d_ob">(*)</div>
                                            </div>
                                    ...
                                    <div class="divTableRow">
                                        ...
                                        <div class="divTableCell">
                                            <div class="tituloTabla1">Distrito<div class="d_ob">(*)</div>
                                            </div>
                                            <select id="s_dist">
                                        ...
                                        <div class="divTableCell">
                                            <div class="tituloTabla1">Dirección<div class="d_ob">(*)</div>
                                            </div>
                                            <input type="text" size="20" maxlength="45" name="campo1" id="campo1"
                                                value="">
                                        </div>
                                    ...
                                    <div class="divTableRow">
                                        ...
                                        <div class="divTableCell" style="width:18%;">
                                            <div class="tituloTabla1">Día<div class="d_ob">(*)</div>
                                            </div>
    ...
    <div style="text-align:center">
        ...
        <div style="text-align:center !important;">
            <div class="checkbox" style="display:inline-block; " id="d_publicidad">
                ...
                <div style="display:inline-block; font-size:1.3em; color:black;"> <span>Deseo recibir ofertas y
                        novedades de Beurer en mi e-mail.</span></div>
            </div>
        </div>

        <br>

        <span style="text-align:left;"><a class="btn " style="background-color:darkgray; color:white;"
                href="#">VOLVER</a></span>
