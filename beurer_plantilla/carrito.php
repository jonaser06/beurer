...
<body style="background-color:rgba(255,255,255,0);">
  <div class="wrapper-header" id="cabecera" style="display:none;">
    <header class="header">
            ...
            <div class="col-md-5 col-sm-3 col-xs-3 hidden-sm hidden-xs izquierdo">
              <ul class="list-rs">
                <li class="">
                  ...
                  <a href="https://instagram.com/beurerperu?igshid=vnrvppz3nm6f" class="instg icon-h"
                    target="_blank"><img src="assets/images/icons/instagram.svg" alt="" class="icn icon-instg"></a>
                  <a href="https://www.youtube.com/channel/UCORqBGCGe3NOrllUAal4COg" class="icn icon-h icon-youtube"
                    target="_blank"></a>
                </li>
                <li class=""><a href="https://api.whatsapp.com/send?phone=+51978 440034" class="icon-h icon-wts"
                    target="_blank"></a><span class="font-nexaregular n-phone visible-lg number">(01) 978 440 034</span>
            </div>
            </li>
            </ul>
            <!-- <div class="row">
              ...
              <div class="text-right txt-mob derecho" style="margin-right:-3%;">
                <form class="div-search d-in-block ocult" method="POST" action="productos/resultado/">
                  <input type="text" class="input-search search_get" name="search_get"
                    ...
                    style="font-size:0.9em; text-align:center; width:0px;">
                ...
                <div class="col-md-3 offset-md-6" style="  top:-6%;">
                  ...
                  <div class="login" style="display:none;">
                    ...
                    <form class="login-container">
                      ...
                      <p style="padding-top:0px !important;margin-top:0px;"><input class="btn btn-primary1"
                          type="submit" value="Iniciar sesión" style="padding:0;"></p>
                        ...
                        <ul class="list-unstyled">
                          ...
                          <li class="nav-header">
                            <a href="#" data-toggle="collapse" data-target="#menu-salud">
                              <h5 class="name-prod"><i class="icon-mob icon-salud"></i>SALUD <i
                                  class="icon-arrow-m-mobile"></i></h5>
                            </a>
                            <ul class="subm-nav-header collapse" id="menu-salud">
                              <li class="item-subm-nav">
                                <a class="link-subm-nav" href="salud/termometros-digitales" data-toggle="collapse"
                                  data-target="#termometros-digitales">
                                  TERMÓMETROS DIGITALES </a>
                              </li>
                              <li class="item-subm-nav">
                                <a class="link-subm-nav" href="#" data-toggle="collapse"
                          ...
                          <li class="nav-header">
                            <a href="#" data-toggle="collapse" data-target="#menu-bienestar">
                              <h5 class="name-prod"><i class="icon-mob icon-bienestar"></i>BIENESTAR <i
                                  class="icon-arrow-m-mobile"></i></h5>
                            </a>
                          ...
                          <li class="nav-header">
                            <a href="#" data-toggle="collapse" data-target="#menu-belleza">
                              <h5 class="name-prod"><i class="icon-mob icon-belleza"></i>BELLEZA <i
                                  class="icon-arrow-m-mobile"></i></h5>
                            </a>
                          ...
                          <li class="nav-header">
                            <a href="#" data-toggle="collapse" data-target="#menu-actividad">
                              <h5 class="name-prod"><i class="icon-mob icon-actividad"></i>ACTIVIDAD <i
                                  class="icon-arrow-m-mobile"></i></h5>
                            </a>
                          ...
                          <li class="nav-header">
                            <a href="#" data-toggle="collapse" data-target="#menu-bebe">
                              <h5 class="name-prod"><i class="icon-mob icon-linea-bb"></i>LINEA BEBE <i
                                  class="icon-arrow-m-mobile"></i></h5>
                            </a>
                          ...
                          <li class="item-nav-enl font-nexaheavy"
                            style="font-size: 20px;text-transform: uppercase;margin-top: 11px;text-align: center;"><a
                              href="#">CONTACTO</a></li>
      ...
      <div class="container-fluid px-0">
        <nav class="content-nav">
                    ...
                    <div class="info-subm">
                      <div class="container cont-menudesplegable">
                        <div class="row">
                          ...
                          <div class=" item-desplegable mm-3"><a href="#">TERMÓMETROS DIGITALES</a>
                          </div>

                          <div class=" item-desplegable mm-3"><a href="#">MEDIDOR DE GLUCOSA</a>
                          </div>

                          <div class=" item-desplegable mm-1"><a href="#">OXÍMETROS</a>
                          </div>

                          <div class=" item-desplegable mm-2"><a href="#">NEBULIZADORES</a>
                          </div>

                          <div class=" item-desplegable mm-10"><a href="#">TENSIÓMETROS </a>
                          </div>

                          <div class=" item-desplegable mm-2"><a href="#">AMPLIFICADORES DE AUDIO</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="info-subm">
                      <div class="container cont-menudesplegable">
                        <div class="row">
                          ...
                          <div class=" item-desplegable mm-10"><a href="#">AIRE Y AROMA</a>
                          </div>

                          <div class=" item-desplegable mm-14"><a href="#">PRODUCTOS TÉRMICOS</a>
                          </div>

                          <div class=" item-desplegable mm-23"><a href="#">SHIATSU Y MASAJE</a>
                          </div>

                          <div class=" item-desplegable mm-2"><a href="#">HIDROMASAJE DE PIES</a>
                          </div>

                          <div class=" item-desplegable mm-4"><a href="#">FOTOTERAPIA</a>
                          </div>

                          <div class=" item-desplegable mm-2"><a href="#">SUEÑO Y RELAJACIÓN</a>
                          </div>

                          <div class=" item-desplegable mm-3"><a href="#">BALANZAS DE EQUIPAJE</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="info-subm">
                      <div class="container cont-menudesplegable">
                        <div class="row">
                          ...
                          <div class=" item-desplegable mm-15"><a href="#">CUIDADO DEL ROSTRO</a>
                          </div>

                          <div class=" item-desplegable mm-8"><a href="#">CUIDADO CORPORAL</a>
                          </div>

                          <div class=" item-desplegable mm-6"><a href="#">CUIDADO DEL CABELLO</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="info-subm">
                      <div class="container cont-menudesplegable">
                        <div class="row">
                          ...
                          <div class=" item-desplegable mm-13"><a href="#">PESO Y DIAGNÓSTICO</a>
                          </div>

                          <div class=" item-desplegable mm-12"><a href="#">TRATAMIENTO DEL DOLOR Y ESTIMULACION MUSCULAR
                            </a>
                          </div>

                          <div class=" item-desplegable mm-1"><a href="#">PULSÓMETRO</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="info-subm">
                      <div class="container cont-menudesplegable">
                        <div class="row">
                          ...
                          <div class=" item-desplegable mm-2"><a href="#">ESTERILIZADORES</a>
                          </div>

                          <div class=" item-desplegable mm-2"><a href="#">EXTRACTORES </a>
                          </div>

                          <div class=" item-desplegable mm-1"><a href="#">BALANZAS </a>
                          </div>

                          <div class=" item-desplegable mm-1"><a href="#">CALENTADOR DE BIBERONES</a>
                          </div>

                          <div class=" item-desplegable mm-1"><a href="#">ASPIRADOR NASAL</a>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <ul class="carrousel-header visible-xs">
            ...
            <li class="item-carrosuel-h font-bold"><a href="#"><i class="icon-h-cars icon-bienestar"></i> bienestar</a>
            </li>
            <li class="item-carrosuel-h font-bold"><a href="#"><i class="icon-h-cars icon-belleza"></i> belleza</a></li>
            <li class="item-carrosuel-h font-bold"><a href="#"><i class="icon-h-cars icon-actividad"></i> actividad</a>
            </li>
            <li class="item-carrosuel-h font-bold"><a href="#"><i class="icon-h-cars icon-linea-bb"></i> linea bebé</a>
            </li>
          </ul>
        </nav>
      </div>
  ...
  <main class="main-detail-products" id="cuerpo" style="display:none;">
    ...
    <div class="formulario" style="text-align:center;width:100%;transform: scale(0.9);background:transparent;"
      align="center">
        ...
        <div class="basket" style="padding:0px;">
          ...
          <div style="background-color:white;border-radius:25px;float:left;padding:.5rem 2rem;margin-bottom:3%;">
            <div class="titulo font-nexaheavy"
              style="margin-top:2%;float:left;margin-left:2%;padding-left:1% !important;border-left:2px solid #c51152;">
            ...
            <div class="row">
              ...
              <div class="col-md-4" style="padding-left:2% !important;">
                ...
                <form class="login-container" style="padding:12px 0px;" action="panel-usuario.php">
                  ...
                  <br>
                  <span><a class="btn btn-cmn" href="producto.php"
                      style="width:80%;padding:7px 0px;font-size:1em;">INICIAR SESIÓN Y COMPRAR</a></span>
                </form>
      ...
      <div class="aside" style="border-radius:3%;">
        ...
        <div style="text-align:center;">
          <div class="checkbox" style="display:inline-block;text-align:left;padding-left:4%;">
            ...
            <div style="display:inline-block; font-size:1.55em;font-family:'nexaheavyuploaded_file';"> Quiero entrega a
              domicilio </div>
          </div>
        ...
        <div id="d_envio" style="display:none;text-align:center; ">
          ...
          <select id="s_depa" style="width:55%" onchange="selectDep();">
          ...
          <select id="s_prov" style="width:55%" onchange="selectProv();">
          ...
          <select id="s_dist" style="width:55%">
        ...
        <div id="campo-cupon" style="display:none; text-align:left;padding-left:4%;">
          <div style="display:inline-flex;">
            ...
            <br>
            <label class="font-light label-pol" style="display:inline;">
              <button class="btn btn-primary1" type="button" style="text-align:center;" maxlength="12">Canjear!</button>
            </label>
        ...
        <div>
          <div
            style="font-size:1.9em;font-weight:bold;text-align:center;color:#c51152;font-family:'nexaregularuploaded_file';">
              ...
              <tbody style="font-size:0.9em;">
                ...
                <tr style="background-color:white;border-bottom:0 none;">
                  <th scope="row" colspan="3"
                    style="font-size:1.35em;color:black;text-align:center;font-weight:bold;vertical-align:middle;">
                    Ingrese aquí su cupón de descuento</th>
      ...
      <div class="modal-dialog modal-dialog-centered" id="modal_foto" role="document">
        <div class="modal-content" style="width:100%">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary1" style="font-size:1.4em;" data-dismiss="modal">Cerrar</button>
          </div>
        </div>
      </div>
    </div>
...
-->
  ...
  <div class="wrapper-footer" id="piedepag" style="display:none;">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-4 col-1-5 visible-lg">
          <h2 class="titles-footer"><a href="rastrea-pedido.php">seguimiento de pedido</a></h2>
        ...
        <div class="col-sm-5 col-md-6 col-1-5 phons-f">
          ...
          <h2 class="phones-footer"><a href="tel:(01) 978 440 034"><i class="icon-f icon-phone"></i> (01) 978 440
              034</a></h2>
          <h2 class="phones-footer"><a href="tel:(01) 255 3738"><i class="icon-f icon-phone"></i> (01) 255 3738</a></h2>


          <!-- EMAIL -->
          <a href="mailto:ventas@beurer.pe" class="link-footer d-block"><i class="icon-f icon-sobre"></i>
            ventas@beurer.pe</a>

          <!-- DIRECCIÓN -->
          <a href="#" class="link-footer d-block"><i class="icon-f icon-ubc"></i> Av. Caminos del Inca Nº 257 Tienda Nº
            149 Santiago de Surco - Lima</a>
              ...
              <div class="checkbox">
                <label class="font-light label-pol">
                  <input type="checkbox" required /><i class="helper"></i><span>He leído y acepto
                    las <a href="politicas-de-privacidad" class="span-pol color-primary btn-modals">Políticas de
                      Privacidad</a></span>
                </label>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="crd2">
          ...
          <p class="oculMob hidden-xs">
            <a href="https://validator.w3.org/check?uri=referer" class="text-f text-credits" target="_blank">HTML </a> •
            <a href="https://jigsaw.w3.org/css-validator/check/referer" class="text-f text-credits"
              target="_blank">CSS</a>
          </p>
        </div>
      </div>
  ...
  <div class="popup-ini" id="login" style="display: none;">
    <div class="popup-inner">
      <img id="img-popup" src="https://beurer.pe/assets/sources/CANALES DE ATENCION-02.jpg" class="img-responsive"
        alt="">
