...
#checkout_crumb .crumb a, #checkout_crumb .step_off:first-child, #checkout_crumb .step_on:first-child, #checkout_crumb_four .crumb a, #checkout_crumb_four .step_off:first-child, #checkout_crumb_four .step_on:first-child {
    margin-left: 0;
}

#checkout_crumb .step_on, #checkout_crumb_four .step_on {
    background: none;
    border: 0;
    border-bottom: 0;
    margin: 0;
...
#checkout_crumb .step_off, #checkout_crumb .step_on, #checkout_crumb_four .step_off, #checkout_crumb_four .step_on {
    text-decoration: none;
    color: #000;
    background: none;
    border: 0;
...
#checkout_crumb_four span.step_on:first-child::before, #checkout_crumb span.step_on:first-child::before {
    content: "1";
    font-size:1.2rem;
    color:white;
    font-weight:bold;
...
#checkout_crumb_four span.step_on:before, #checkout_crumb span.step_on:before {
    background: #c51152;
    color: #000;
    position: relative;
    top: 0;
...
#checkout_crumb_four span.step_off:before, #checkout_crumb_four span.step_on:before, #checkout_crumb span.step_off:before, #checkout_crumb span.step_on:before {
    border-radius: 50%;
    padding: 10px;
    margin-right: 8px;
    font-family: "nexa-lightuploaded_file";
...
#checkout_crumb_four span.step_on:after, #checkout_crumb span.step_on:after {
    display: block;
    text-transform: none;
    padding-left: 0;
    font-size: 1em;
...
#checkout_crumb_four span.step_off:before, #checkout_crumb span.step_off:before {
    background: darkgray;
    color: #000;
    position: relative;
    top: 0;
...
#checkout_crumb_four span.step_off:before, #checkout_crumb_four span.step_off:before, #checkout_crumb span.step_off:before, #checkout_crumb span.step_off:before {
    border-radius: 50%;
    padding: 10px;
    margin-right: 8px;
    font-family: "nexa-lightuploaded_file";
...
#checkout_crumb_four span.step_off:nth-child(3):before, #checkout_crumb span.step_off:nth-child(3):before {
    content: "2";
    font-size:1.2rem;
    color:white;
    font-weight:bold;
...
#checkout_crumb_four span.step_off:nth-child(5):before, #checkout_crumb span.step_off:nth-child(5):before {
    content: "3";
    font-size:1.2rem;
    color:white;
    font-weight:bold;
...
#checkout_crumb_four span.step_off:nth-child(7):before, #checkout_crumb span.step_off:nth-child(7):before {
    content: "4";
    font-size:1.2rem;
    color:white;
    font-weight:bold;
...
<main2>
    <div class="basket" style="background-color:#f50057;padding:0px;background-color:transparent !important;">
      
      <div style="background-color:white;padding:1rem 2rem;border-radius:5%;margin-bottom:2%;">
      ...
      <table class="table tbl-resumen" style="font-size:1.4em;">
        <thead class="font-light" style="font-size:1rem;color:#c51152;text-align:center;">
            <tr >
            <th style="padding-right:8%;width:34%;" scope="col" colspan="2">PRODUCTOS</th>
            <th style="width:24%" scope="col">PRECIO UNITARIO</th>
            <th style="width:22%" scope="col">CANTIDAD</th>
            <th style="width:20%" scope="col">SUBTOTAL</th>
            </tr>
        </thead>
        <tbody style="font-size:0.9em;">
        <tr style="padding:1rem 12rem;">
            <td style="width:13.2%;"> <a class="product-image" data-toggle="modal" onclick="modal()" data-target="#exampleModal" >
            <img src="https://beurer.pe/assets/sources/CM50_01.jpg" style="width:92%;" alt="Placholder Image 2" class="product-frame">
          </a></td>
            <td class="product-details" style="width:100%;padding:.5rem 1rem"><span>MASAJEADOR ANTICELULÍTICO CM 50</span>
            <p>SKU: 232321939</p>  
            <p>Envío a domicilio</p></td>
            <td><div class="info-prod" style="display:block;"> 
            <img src="assets/images/precio-online.png">
            <div class="font-nexaheav text-left price rprice"> 100.00</div>	
        </div>
        <div class="font-nexaheav  " style="font-size:1em;text-align:center;font-weight:bold;font-family:'nexa-lightuploaded_file';" >Normal: S/ 25.69</div></td>
            <td style="text-align:center;"><button id="dism"  style="width:20%; margin: 0 8%;" onclick="disminuir()">-</button>
            <input class="form-control-field cantidad"  name="pwd" value="1" type="text" id="cantidad_prod"  min="1"  readonly>
            <button id="aum" style="width:20%; margin: 0 8%;" onclick="aumentar()">+</button></td>
            <td style="font-size:1.85em;text-align:center;font-family:'nexaheavyuploaded_file';color:black;">26.00</td>
        </tr>
        ...
        <tr>
            ...
            <td class="product-details" style="width:100%;padding:0.5rem 1rem"><span>MASAJEADOR ANTICELULÍTICO CM 50</span>
            <p>SKU: 232321939</p>  
            <p>Envío a domicilio</p></td>
            <td><div class="info-prod" style="display:block;"> 
            <img src="assets/images/precio-online.png">
      ...
      <div style="width:100%; text-align:left;color:black;background-color:white;padding:1rem 2rem;border-radius:5%;" >
        
        <div class="row">
        <div class="titulo font-nexaheavy" style="margin-top:2%;margin-left:2%;padding-left:1% !important;border-left:2px solid #c51152;" >INGRESA TUS DATOS</div>
        <br>
            <div class="col-md-4" style="padding-left:2% !important;">
                ...
                <br><br><br><br><br>
                <span ><a class="btn btn-cmn" href="producto.php"  style="width:80%;padding:7px 0px;font-size:1em;">REGÍSTRATE AQUÍ</a></span>		
                
            </div>
            <div class="col-md-4" style="border-left:1px solid rgba(169,169,169,0.5);border-right:1px solid rgba(169,169,169,0.5);padding-left:2% !important;">
            <div class=" font-nexaregular" style="font-weight:bold;margin-bottom:2%;" >Compra sin clave</div>
            <span class="font-light">Solo te pediremos algunos datos para el despacho. No serán guardados para tu próxima compra. </span>
            <br><br><br><br>
            <span ><a class="btn btn-cmn" href="producto.php"  style="width:80%;padding:7px 0px;font-size:1em;">CONTINUAR SIN REGISTRARSE</a></span>		
            </div>
            <div class="col-md-4" style="padding-left:2% !important;">
            <div class=" font-nexaregular" style="font-weight:bold;margin-bottom:2%;" >Compra sin clave</div>
            ...
            <p class="font-light" style="line-height:0px;">Contraseña</p>                
                            ...
                            <br>
                            <span ><a class="btn btn-cmn" href="producto.php"  style="width:80%;padding:7px 0px;font-size:1em;">INICIAR SESIÓN Y COMPRAR</a></span>		                                        
                        </form>
        ...
        <div id="campo-cupon" style="display:none; text-align:left;padding-left:4%;">
            <div  style="display:inline-flex;">
                <label class="font-light label-pol" style="display:inherit; margin-right:2%;">
                    <input type="text" style="text-align:center;border: 1px solid black;" maxlength="12" /><i class="helper"></i>
                </label>
<br>
                <label class="font-light label-pol" style="display:inline;">
...
<div  >
  ...
  <tbody style="font-size:0.9em;">
    ...
    <tr style="background-color:white">
      <th scope="row" colspan="2" style="text-align:right; vertical-align:middle;"><input type="text" placeholder="Ej. 6W79H6" style="border: 1px solid black;" maxlength="12" /><i class="helper"></i></th>
      
      <td  id="d_costonvio" style="color:#c51152; font-size:1.2em;"><label class="font-light label-pol" style="display:inline;">
...
<br>
  ...
  <div class="modal-dialog modal-dialog-centered" id="modal_foto" role="document" >
    <div class="modal-content" style="width:100%">
      ...
      <img src="https://beurer.pe/assets/sources/CM50_01.jpg" style="box-shadow:-3px 3px 25px -3px rgba(0,0,0,0.3); " alt="Placholder Image 2" >
      </div>
